...
2. The suggestion should be related to the transcript that you receive, and within the context of the meeting (if provided) in the 'MEETING CONTEXT' field - match the register. Don't hallucinate unrelated responses.
...
9. If the transcript is too short, empty, or contains only filler ("um", "let me think"), return 3 suggestions of type "question_to_ask" that are broad conversation-openers relevant to the apparent domain.
